...
<tbody>
	<tr>
		<td>
			...
			<a class="vlightbox1" href="<%=request.getContextPath() %>/res/images/image_lightbox.jpg">
				<img src="<%=request.getContextPath() %>/res/images/image_lightbox.jpg" alt="Image Lightbox" width="150" height="150">Image Lightbox
			</a>
			
			<br>
			
			<a class="vlightbox1" href="<%=request.getContextPath() %>/res/images/jquery_lightbox.jpg" alt="Lightbox Features">
			<img src="<%=request.getContextPath() %>/res/images/jquery_lightbox.jpg" alt="Lightbox features" width="150" height="150">Lightbox Features
				<div class="vlb_zoom" style="position: absolute; display: none;">Lightbox Features</div>
			</a>
