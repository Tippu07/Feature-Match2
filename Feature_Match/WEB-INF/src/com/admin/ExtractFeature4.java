...
public class ExtractFeature4 extends HttpServlet
{
	@Override
	public void service(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException
	{
		...
		String root = "",filePath="",fileName="",imgFeature1;
		 ...
		 else
		 {
			...
			try
			{
				...
				while(rs.next())
				{
					...
					img = AvgRGB.readImage(filePath);
				    avgRgbVal = AvgRGB.getAvgRGBFeature(img);
				    System.out.println("Avg RGB Value : " + avgRgbVal);
					
				    imgFeature1 = avgRgbVal.get(0)+"-"+avgRgbVal.get(1)+"-"+avgRgbVal.get(2);
				    
				    //Updating The Features In Database
				    flag = AdminDAO.updateImgFeature1(imageId, imgFeature1);
				}
...
*/				
			...
			{
				System.out.println("Opps,Exception In ExtractFeature4 Servlet : " );
				e.printStackTrace();
				rd=request.getRequestDispatcher("/res/JSP/Admin/feature_extraction.jsp?no=2");
				rd.forward(request, response);
			}
