 ...
 */
	 ...
	 */
	public Vector getXYAreaVector(BufferedImage image)
	{
		Vector colorCoherenceVector = new Vector(128);
		Vector coherenceList = new Vector();
		...
		//image.blur();
		int[] blurpixels = getPackedRGBPixel(image);
 ...
 */
	 ...
	 */
	public Vector getXYBoundaryVector(BufferedImage image) {
		Vector area = getXYAreaVector(image);
