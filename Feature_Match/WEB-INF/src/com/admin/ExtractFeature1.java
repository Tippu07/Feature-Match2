...
public class ExtractFeature1 extends HttpServlet
{
		 ...
		 else
		 {
			...
			try
			{
				...
				while(rs.next())
				{
					...
					featureVector = e.getFeatureVector(img);;
				    System.out.println("Edgefrequency Feature Vector :\n" + featureVector);
				    ...
				    flag = AdminDAO.updateImgFeature2(imageId, imgFeature2);
				}
...
*/				
			...
			{
				System.out.println("Opps,Exception In ExtractFeature1 Servlet : " );
				e.printStackTrace();
				rd=request.getRequestDispatcher("/res/JSP/Admin/feature_extraction.jsp?no=2");
				rd.forward(request, response);
			}
